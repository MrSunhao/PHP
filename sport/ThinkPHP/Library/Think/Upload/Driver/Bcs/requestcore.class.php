...
class BCS_RequestCore {
	...
	/**
	 * Regist a callback function to execute whenever a data stream is read from using
	...
	/**
	 * Regist a callback function to execute whenever a data stream is written to using
